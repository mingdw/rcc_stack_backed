...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '101000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '102000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '103000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '104000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '105000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '106000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '107000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '201000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '202000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '203000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '204000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '301000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '302000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '303000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '401000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '402000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '403000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '501000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '502000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '503000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '601000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '602000'
UNION ALL
...
SELECT 
    ...
    'admin' as creator,
    'admin' as updator
FROM sys_category WHERE code = '603000'
UNION ALL
...
JOIN sys_category c3 ON c3.parent_id = c2.id
...
(`product_spu_id`, `product_spu_code`, `detail`, `packing_list`, `after_sale`, `creator`, `updator`)
SELECT 
    spu.id,
    spu.code,
    -- 商品详情HTML
    ...
    'admin' as creator,
    'admin' as updator
FROM `sys_product_spu` spu
WHERE NOT EXISTS (
    SELECT 1 
    FROM `sys_product_spu_detail` detail 
    WHERE detail.product_spu_id = spu.id
);