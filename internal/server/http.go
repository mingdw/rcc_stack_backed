...
func mallApi(router *gin.RouterGroup, categoryHandler *handler.CategoryHandler, productHandler *handler.ProductHandler, addressHandler *handler.AddressHandler, userAddressHandler *handler.UserAddressHandler, contractHandler *handler.ContractHandler) {
	...
	router.PUT("/categories/group/modify", categoryHandler.ModifyCategoryGroup)
	router.DELETE("/categories/group/delete/:id", categoryHandler.DeleteCategoryGroup)
	router.PUT("/categories/group/attr/modify", categoryHandler.ModifyCategoryGroupAttr)
	router.DELETE("/categories/group/attr/delete/:id", categoryHandler.DeleteCategoryGroupAttr)
